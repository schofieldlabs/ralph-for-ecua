  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-emerald-50 text-slate-800">
      ...
      <header className="sticky top-0 z-50 backdrop-blur bg-white/75 border-b">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <a href="#home" className="flex items-center gap-2 font-bold text-xl">
            <Droplets className="h-6 w-6" /> Ralph for ECUA — D4
          </a>
      ...
      <section id="home" className="relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-28 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-3 text-xs text-slate-500">Paid by Ralph Schofield, candidate for ECUA District 4. Content approved by the candidate.</p>
          </div>
          ...
          <Card className="shadow-lg rounded-2xl">
            <CardContent className="p-7">
              ...
              <div className="mt-4 grid gap-3">
                ...
                <a className="inline-flex items-center gap-2 rounded-2xl border px-4 py-2 hover:bg-slate-50" href="mailto:info@your-campaign.org"><Mail className="h-4 w-4"/> info@your‑campaign.org</a>
              </div>
            </CardContent>
          </Card>
        </div>
      ...
      <footer className="border-t bg-white/70">
        <div className="max-w-6xl mx-auto px-4 py-8 text-sm text-slate-600 grid md:grid-cols-2 gap-4">
          <div>
            © {new Date().getFullYear()} Ralph Schofield for ECUA District 4. All rights reserved.
          </div>
...
function PlanCard({ icon, title, bullets }) {
  return (
    <Card className="rounded-2xl shadow-lg">
      <CardContent className="p-6">
        ...
        <ul className="mt-3 space-y-2 text-slate-600">
          {bullets.map((b, i)=> (
            <li key={i} className="flex items-start gap-2"><CheckCircle className="h-5 w-5 text-emerald-600 mt-0.5"/> {b}</li>
          ))}
        </ul>
      </CardContent>
    </Card>
...
function UpdateCard({ title, date, summary }) {
  return (
    <Card className="rounded-2xl shadow">
      <CardContent className="p-6">
        ...
        <a className="mt-3 inline-flex items-center gap-2 text-emerald-700 font-medium" href="#">Read more <ArrowRight className="h-4 w-4"/></a>
      </CardContent>
    </Card>
  );
}
